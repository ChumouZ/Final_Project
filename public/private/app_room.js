...
function setup() {
    let myCanvas = createCanvas(600, 402);
...
function draw() {
    ...
    noStroke(0);
    fill(255);
    rect(450, 220, 100, 30, 5);
    fill(0);
    textSize(18);
    text("Black: ", 460, 242);
    text(cntBlack, 520, 242);
    fill(0);
    rect(450, 300, 100, 30, 5);
    fill(255);
    text("White: ", 460, 322);
    text(cntWhite, 520, 322);

    if (turn == true) {
        fill(231, 231, 174);
        rect(473, 22, 120, 60, 7);
        fill(255);
        circle(443, 52, 40);
        textSize(21);
        text("White’s turn", 473, 60);
    }
    else {
        fill(231, 231, 174);
        rect(463, 22, 120, 60, 7);
        fill(0);
        circle(443, 52, 40);
        textSize(21);
        text("Black’s turn", 473, 60);
    }
